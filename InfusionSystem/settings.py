"""
Django settings for InfusionSystem project.
...
SECRET_KEY = "django-insecure-87_&&3qzi^np&778t5qj5n&52$*o0h+3dunxn23nv$mr986kz6"
...
ROOT_URLCONF = "InfusionSystem.urls"
...
DATABASES = {
    "default": {
        "ENGINE": "mssql",
        "NAME": "test",
        "USER": "sa",  # Leave this blank for Windows authentication
        "PASSWORD": "HZxxk8399..",  # Leave this blank for Windows authentication
        "HOST": "2.0.6.77",
        # 'PORT': '1833',
        "OPTIONS": {
